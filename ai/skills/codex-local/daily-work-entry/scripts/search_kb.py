#!/usr/bin/env python3
"""Search the personal knowledge base for daily work and idea context."""
...
SCOPES = {
    ...
    "work": ["05-Daily-Workspace", "00-Agent-State/work-state.yaml", "50-Projects"],
    "ideas": ["06-Ideas", "00-Agent-State/idea-state.yaml"],
    "index": ["30-Agent-Index"],
    "knowledge": ["10-Knowledge-Cards", "20-Source-Cards", "40-Mental-Models"],
...
def main() -> int:
    ...
    parser.add_argument("query", help="Search query or work/idea context.")
    ...
    print("# Daily work knowledge search\n")
    print(f"- KB: `{kb}`")
    ...
    if not results:
        print("No strong matches. Try fewer or more concrete terms, then inspect state and indexes manually.")
        return 0
